...
{
       // It is as easy as returning the value of firstName variable
       return firstName;
 ...
 * the function returns the height ( in inches ) of a patient
 */
 ...
 * the function returns the weight ( in pounds ) of a patient
 */
...
void HealthProfile::setAge( int currYear, int currMonth, int currDay, int birth_year, int birth_month, int birth_day )
{
    ...
    if( change_inMonth >= 0 )                            // Check to see if the change in month is equal or greater than zero
    {
            if( change_inMonth = 0 )                     // is the change in month equal to zero? if this is true then
            {
                   if( change_inDay >= 0)                // check the difference in day... 
                   {
                           if( change_inDay == 0)        // suppose this is true... then it's his/her birth day
                           {
                                    age = change_inYear; // return the age and... Wish him or her Happy Birth Day
                                      
                           }
                           else  age = change_inYear;    // otherwise just return the age
                   }
                   else age = change_inYear - 1;         // else subtract 1 from the age
            }
            else  age = change_inYear;                   // hmmm..... just age
    
      }    
      else age = change_inYear - 1;                      // or........subtract....1...from age
}               
